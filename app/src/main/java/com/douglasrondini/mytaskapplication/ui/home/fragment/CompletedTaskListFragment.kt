...
class CompletedTaskListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_completed_task_list, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment CompletedTaskListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompletedTaskListFragment().apply {
